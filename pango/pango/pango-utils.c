...
pango_load_aliases (void)
{
  ...
  alias->n_families = 6;
  alias->alias = "serif";
  alias->families = g_malloc (sizeof (char *) * 6);
  alias->families[0] = "times new roman";
  alias->families[1] = "angsana new";/*thai*/
  alias->families[2] = "mingliu";/*traditional chinese*/
  alias->families[3] = "simsun";/*simplified chinese*/
  alias->families[4] = "gulimche";/*korean*/
  alias->families[5] = "ms gothic";/*japanese*/
//  alias->visible = TRUE;
  g_hash_table_insert (pango_aliases_ht,
		       alias, alias);
  ...
  alias = g_new0 (struct PangoAlias, 1);
  alias->n_families = 7;
  alias->alias = "monospace";
  alias->families = g_malloc (sizeof (char *) * 7);
  alias->families[0] = "lucida console";
  alias->families[1] = "courier new";
  alias->families[2] = "courier monothai";
  alias->families[3] = "mingliu";/*traditional chinese*/
  alias->families[4] = "simsun";/*simplified chinese*/
  alias->families[5] = "gulimche";/*korean*/
  alias->families[6] = "ms gothic";/*japanese*/
//  alias->visible = TRUE;
  g_hash_table_insert (pango_aliases_ht,
		       alias, alias);
  ...
  alias->alias = "sans";
  alias->families = g_malloc (sizeof (char *) * 6);
  alias->families[0] = "tahoma";
  alias->families[1] = "arial";
  alias->families[2] = "mingliu";/*traditional chinese*/
  alias->families[3] = "simhei";/*simplified chinese*/
  alias->families[4] = "gulimche";/*korean*/
  alias->families[5] = "ms gothic";/*japanese*/
//  alias->visible = TRUE;
  g_hash_table_insert (pango_aliases_ht,
