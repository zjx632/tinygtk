...
static mylist *dlist = NULL;

static mylist *
mylist_add(mylist *list, void *data)
{
...
static mylist *
mylist_del(mylist *list, void *data)
{
	mylist *l = list;
	mylist *p = NULL;
...
void mem_remove_dlist (void *data)
{
	dlist = mylist_del(dlist, data);
}

void
g_mem_dump_dlist (void)
{
	mylist *list = dlist;
	int i = 0;
	int mem = 0;
...
//		dlist = mylist_add (dlist, new_str);
    }
  else
    new_str = NULL;
