 ...
 **/
GParamSpec*
g_param_spec_booleanA (const gchar *name,
		     /* const gchar *nick,
		      const gchar *blurb,*/
 ...
 **/
GParamSpec*
g_param_spec_intA (const gchar *name,
		  gint	       minimum,
		  gint	       maximum,
		  gint	       default_value,
		  GParamFlags  flags)
 ...
 **/
GParamSpec*
g_param_spec_uintA (const gchar *name,
		   /*const gchar *nick,
		   const gchar *blurb,*/
		   guint	minimum,
		   guint	maximum,
...
GParamSpec*
g_param_spec_enumA (const gchar *name,
		/*   const gchar *nick,
		   const gchar *blurb,*/
		   GType	enum_type,
		   gint		default_value,
...
GParamSpec*
g_param_spec_flagsA (const gchar *name,
		   /* const gchar *nick,
		    const gchar *blurb,*/
		    GType	 flags_type,
		    guint	 default_value,
 ...
 **/
GParamSpec*
g_param_spec_floatA (const gchar *name,
		   /* const gchar *nick,
		    const gchar *blurb,*/
		    gfloat	 minimum,
		    gfloat	 maximum,
 ...
 **/
GParamSpec*
g_param_spec_doubleA (const gchar *name,
		    /* const gchar *nick,
		     const gchar *blurb,*/
		     gdouble	  minimum,
		     gdouble	  maximum,
...
GParamSpec*
g_param_spec_stringA (const gchar *name,
		   /*  const gchar *nick,
		     const gchar *blurb,*/
 ...
 **/
GParamSpec*
g_param_spec_boxedA (const gchar *name,
		   /* const gchar *nick,
		    const gchar *blurb,*/
		    GType	 boxed_type,
		    GParamFlags  flags)
...
GParamSpec*
g_param_spec_objectA (const gchar *name,
		     /*const gchar *nick,
		     const gchar *blurb,*/
		     GType	  object_type,
		     GParamFlags  flags)
