  ...
  if (GTK_WIDGET_DRAWABLE (widget))
    {
      ...
      gtk_paint_hline (widget->style, widget->window, GTK_STATE_NORMAL, NULL, widget,
			NULL, 0, widget->allocation.width, widget->allocation.height-1);
    }
}
