                      ...
                      GtkIconSet     *icon_set)
{
  ...
  if (old_key)
   ...
   // g_hash_table_insert (factory->icons, g_strdup (stock_id), icon_set);
    g_hash_table_insert (factory->icons, stock_id, icon_set);
...
get_default_icons (GtkIconFactory *factory)
{
  ...
  /* Generic + menu sizes */  
  add_unsized (factory, stock_add_16, GTK_STOCK_ADD);
...
/*  add_sized_with_fallback (factory,
  ...
  add_unsized (factory, stock_copy_16, GTK_STOCK_COPY);

  add_unsized (factory, stock_cut_16, GTK_STOCK_CUT);

  add_unsized (factory, stock_down_arrow_16, GTK_STOCK_GO_DOWN);
...
/*  add_sized_with_fallback (factory,
  ...
  add_sized_with_fallback (factory,
			   ...
			   GTK_ICON_SIZE_MENU,
			   GTK_STOCK_QUIT);*/
  add_unsized (factory, stock_exit_16, GTK_STOCK_QUIT);
  ...
  add_unsized (factory, stock_help_16, GTK_STOCK_HELP);
 ...
 /* add_sized_with_fallback (factory,
  ...
  add_unsized (factory, stock_preferences_16, GTK_STOCK_PREFERENCES);
...
/*  add_sized_with_fallback (factory,
  ...
  add_unsized (factory, stock_remove_16, GTK_STOCK_REMOVE);
/*  add_sized_with_fallback (factory,
			   stock_remove_24,
			   stock_remove_16,
			   GTK_ICON_SIZE_MENU,
...
/*  add_sized_with_fallback (factory,
  ...
  add_unsized (factory, stock_search_16, GTK_STOCK_FIND);
...
/*  add_sized_with_fallback (factory,
  ...
  add_unsized (factory, stock_spellcheck_16, GTK_STOCK_SPELL_CHECK);
