 ...
 */
void                  __fastcall gtk_entry_set_text        (GtkEntry      *entry,
                                                 const gchar   *text);
/* returns a reference to the text */
#define gtk_entry_get_text(e) (GTK_ENTRY(e)->text)
...
gint         gtk_entry_find_position            (GtkEntry       *entry,
							gint            x);
void         gtk_entry_clear_error_range        (GtkEntry *entry);
void         gtk_entry_add_error_range          (GtkEntry *entry,
                                                 gint start,
                                                 gint end);
