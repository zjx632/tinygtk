...
void	   __fastcall gtk_box_pack_start	       (GtkBox	     *box,
					GtkWidget    *child,
					gboolean      expand,
					gboolean      fill,
					guint	      padding);
void	   __fastcall gtk_box_pack_end	       (GtkBox	     *box,
					GtkWidget    *child,
					gboolean      expand,
					gboolean      fill,
					guint	      padding);
...
void	   gtk_box_pack_end_defaults   (GtkBox	     *box,
					GtkWidget    *widget);
void	   __fastcall gtk_box_set_homogeneous     (GtkBox	     *box,
					gboolean      homogeneous);
gboolean   gtk_box_get_homogeneous     (GtkBox	     *box);
void	   gtk_box_set_spacing	       (GtkBox	     *box,
					gint	      spacing);
gint       gtk_box_get_spacing         (GtkBox       *box);
void	   __fastcall gtk_box_reorder_child       (GtkBox	     *box,
					GtkWidget    *child,
					gint	      position);
