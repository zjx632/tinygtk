...
#define ONCE_PER_CLASS() \
  ...
  switch (wtype)
    ...
    case GDK_WINDOW_TOPLEVEL:
      if (0 == klassTOPLEVEL)
	{
	  wcl.lpszClassName = "xchatWindowToplevel";
    ...
    case GDK_WINDOW_CHILD:
      if (0 == klassCHILD)
	{
	  wcl.lpszClassName = "xchatWindowChild";
    ...
    case GDK_WINDOW_DIALOG:
      if (0 == klassDIALOG)
	{
	  wcl.lpszClassName = "xchatWindowDialog";
...
void          
gdk_window_set_iconAA (GdkWindow *window, 
...
gdk_window_set_keep_above (GdkWindow *window, gboolean setting)
{
  ...
  if (GDK_WINDOW_IS_MAPPED (window))
    ...
    gdk_synthesize_window_state (window, 0, 0);
}
